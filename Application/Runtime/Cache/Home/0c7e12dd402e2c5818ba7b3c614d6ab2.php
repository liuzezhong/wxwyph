          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php if(is_array($wxuserList)): $i = 0; $__LIST__ = $wxuserList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?><tr>
                        <td class="text-center"><?php echo ($user["real_name"]); ?></td>
                        <td class="text-center"><?php echo ($user["nickname"]); ?></td>
                        <td class="text-center"><?php echo ($user["openid"]); ?></td>
                        <td class="text-center"><?php echo ($user["gender"]); ?></td>
                        <td class="text-center"><?php echo ($user["country"]); ?></td>
                        <td class="text-center"><?php echo ($user["province"]); ?></td>
                        <td class="text-center"><?php echo ($user["city"]); ?></td>
                        <td class="text-center"><a href="<?php echo ($user["avatarurl"]); ?>" target="_blank">查看</a></td>
                        <td class="text-center">
                            <?php if($user["status"] == 0): ?><span class="label label-danger" id="change-wxuser-status" attr-id="<?php echo ($user["user_id"]); ?>" attr-status="<?php echo ($loan["loan_status"]); ?>" attr-m="home" attr-c="other" attr-a="changeWxuserStatus"><?php echo ($user["status_name"]); ?></span>
                                <?php elseif($user["status"] == 1): ?>
                                <span class="label label-success" id="change-wxuser-status" attr-id="<?php echo ($user["user_id"]); ?>" attr-status="<?php echo ($loan["loan_status"]); ?>" attr-m="home" attr-c="other" attr-a="changeWxuserStatus"><?php echo ($user["status_name"]); ?></span><?php endif; ?>
                        </td>
                        <td class="text-center"><?php echo ($user["depart_name"]); ?></td>
                        <td class="text-center"><?php echo ($user["company_name"]); ?></td>
                        <td class="text-center"><?php echo ($user["gmt_create"]); ?></td>
                        <td class="text-center"><span id="edit-Wxuser" attr-id="<?php echo ($user["user_id"]); ?>" attr-m="home" attr-c="other" attr-a="editWxuser" data-toggle="modal" data-target="#editInfoModal"><i class="fa fa-edit fa-fw"></i></span>&nbsp;<span id="delete-info" attr-id="<?php echo ($user["user_id"]); ?>" attr-name="<?php echo ($user["nickname"]); ?>的账号" attr-m="home" attr-c="other" attr-a="deleteWxUser"><i class="fa fa-trash-o fa-fw"></i></span></td>
                    ...
                    <form role="form" id="baoju-edit-form">
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <select class="form-control selectpicker show-tick" title="选择所属部门" data-size="8" name="depart_id" id="edit-depart_id">
                                <?php if(is_array($departments)): $i = 0; $__LIST__ = $departments;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$depart): $mod = ($i % 2 );++$i;?><option value="<?php echo ($depart["department_id"]); ?>"><?php echo ($depart["department_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
