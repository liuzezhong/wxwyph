              ...
              <div class="panel panel-default">
                  <div class="panel-body panel-body-footer">
                      <form class="form-inline search-line" action="/index.php" method="get">
                          ...
                          <div class="form-group">
                              <label>发送日期&nbsp;</label>
                              <input type="text" class="form-control" placeholder="按发送时间范围搜索" size="40" name="search_datepicker" value="<?php echo ($input_datepicker); ?>" id="reservationtime">
                          </div>
          ...
          <div class="box">
            <div class="box-header">
              <!--<h3 class="box-title">Data Table With Full Features</h3>-->
                ...
                <h5><text class="text-info">发送数量合计：<?php echo ($countMessage); ?>（条）</text>

                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <text class="text-info">短信费用合计：<?php echo ($sumMoney); ?>（元）</text></h5>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php if(is_array($messages)): $i = 0; $__LIST__ = $messages;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$message): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td class="text-center"><?php echo ($message["message_id"]); ?></td>
                        <td class="text-center"><?php echo ($message["gmt_create"]); ?></td>
                        <td class="text-center"><?php echo ($message["name"]); ?></td>
                        <td class="text-center"><?php echo ($message["phone"]); ?></td>
                        <td class="text-center" style="max-width:500px;!important;"><?php echo ($message["param_detail"]); ?></td>
                        <td class="text-center">
                            <?php if($message["send_status"] == 1): ?><text class="text-success"><?php echo ($message["send_status_name"]); ?></text>
                                <?php elseif($message["send_status"] == 0): ?>
                                <text class="text-warning"><?php echo ($message["send_status_name"]); ?></text>
                                <?php elseif($message["send_status"] == -1): ?>
                                <text class="text-danger"><?php echo ($message["send_status_name"]); ?></text><?php endif; ?>

                            </td>
                        <td class="text-center"><?php echo ($message["remark"]); ?></td>
                        <?php if($userInfo["jurisdiction"] == 2): ?><td class="text-center"><?php echo ($message["company_name"]); ?></td><?php endif; ?>
                        ...
                        <!--<?php if($userInfo["jurisdiction"] == 2): ?>-->
                            <!--<div class="form-group col-lg-12">-->
                                ...
                                <!--<select class="form-control selectpicker show-tick" title="选择支出所属公司" data-size="8" name="company_id" >-->
                                    <!--<?php if(is_array($companys)): $i = 0; $__LIST__ = $companys;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$company): $mod = ($i % 2 );++$i;?>-->
                                        <!--<option value="<?php echo ($company["company_id"]); ?>"><?php echo ($company["smallname"]); ?></option>-->
