                  ...
                  <div class="panel-body panel-body-footer">
                      <form class="form-inline search-line" >
                          ...
                          <div class="form-group">
                              <label>员工姓名&nbsp;</label>
                              <input type="text" class="form-control" placeholder="按员工姓名搜索" size="15" name="search_name" value="<?php echo ($input_name); ?>">
                          </div>
                          &nbsp;&nbsp;
                          <div class="form-group">
                              <label>手机号码&nbsp;</label>
                              <input type="text" class="form-control" placeholder="按员工手机号码搜索" size="15" name="search_phone" value="<?php echo ($input_phone); ?>">
                          </div>
                          &nbsp;&nbsp;
                          <div class="form-group">
                              <label>身份证号&nbsp;</label>
                          ...
                          <div class="form-group">
                              ...
                              <select class="form-control selectpicker show-tick" title="按所属部门搜索" data-size="8" name="search_department" id="search_department" data-width="fit" multiple>
                                  <?php if(is_array($departments)): $i = 0; $__LIST__ = $departments;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$department): $mod = ($i % 2 );++$i; if($department["selected"] == 1): ?><option value="<?php echo ($department["department_id"]); ?>" selected><?php echo ($department["department_name"]); ?></option>
                                          <?php else: ?>
                                          <option value="<?php echo ($department["department_id"]); ?>"><?php echo ($department["department_name"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                              </select>
                          </div>
                          ...
                          <div class="form-group">
                              <label>入职时间&nbsp;</label>
                              <input type="text" class="form-control" placeholder="按入职时间范围搜索" size="40" name="search_datepicker" value="<?php echo ($input_datepicker); ?>" id="reservationtime">
                          </div>
                          &nbsp;&nbsp;
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php if(is_array($staffs)): $i = 0; $__LIST__ = $staffs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$staff): $mod = ($i % 2 );++$i;?><tr>
                    <td class="text-center"><?php echo ($staff["staff_id"]); ?></td>
                    <td class="text-center"><?php echo ($staff["staff_name"]); ?></td>
                    <td class="text-center"><?php echo ($staff["phone_number"]); ?></td>
                    <td class="text-center"><?php echo ($staff["idcard"]); ?></td>
                    <td><?php echo ($staff["address"]); ?></td>
                    <td class="text-center"><?php echo ($staff["department_name"]); ?></td>
                    <!--<td class="text-center"><?php echo ($staff["base_pay"]); ?></td>
                    <td class="text-center"><?php echo ($staff["bank_card"]); ?></td>-->


                    <td class="text-center">
                      <?php if($staff["staff_status"] == 0): ?><span class="label label-success" id="change-status" attr-id="<?php echo ($staff["staff_id"]); ?>" attr-status="<?php echo ($staff["staff_status"]); ?>" attr-m="home" attr-c="staff" attr-a="changeStatus">在职</span>
                        <?php elseif($staff["staff_status"] == -1): ?>
                        <span class="label label-danger" id="change-status" attr-id="<?php echo ($staff["staff_id"]); ?>" attr-status="<?php echo ($staff["staff_status"]); ?>" attr-m="home" attr-c="staff" attr-a="changeStatus">离职</span><?php endif; ?>
                    </td>
                      <?php if($userInfo["jurisdiction"] == 2): ?><td class="text-center"><?php echo ($staff["company_name"]); ?></td><?php endif; ?>

                      <td class="text-center"><?php echo (date("Y年m月d日",$staff["induction_time"])); ?></td>
                    <td class="text-center"><span id="edit-info" attr-id="<?php echo ($staff["staff_id"]); ?>" attr-m="home" attr-c="staff" attr-a="editStaff" data-toggle="modal" data-target="#editInfoModal"><i class="fa fa-edit fa-fw"></i></span>&nbsp;<span id="delete-info" attr-id="<?php echo ($staff["staff_id"]); ?>" attr-name="<?php echo ($staff["staff_name"]); ?>" attr-m="home" attr-c="staff" attr-a="deleteStaff"><i class="fa fa-trash-o fa-fw"></i></span></td>
