    ...
    <div class="login-box-body">
        <p class="login-box-msg">请输入电子邮箱和密码</p>
            <div class="form-group has-feedback">
                <input type="text" class="form-control" placeholder="手机号码或电子邮箱" name="username">
            ...
            <div class="form-group has-feedback">
                <input type="text" class="form-control" placeholder="验证码" name="vercode">
                <span class="glyphicon glyphicon-bookmark form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
                <a href="#" id="ver_code"><img src='<?php echo U("home/login/verify");?>' id="ver_code_img"  alt="请点击刷新验证码" title="点击刷新验证码" onclick="this.src='/index.php/home/login/verify.html?id=' + Math.random();"/></a>
        ...
        <!--<div style="margin-top: 15px">-->
            <!--<a href="<?php echo U('home/register/index');?>" class="text-center">注册一个新的账号</a>-->
        <!--</div>-->
...
<div class="container">
    <div class="row">
        <div class="col-md-12 text-center">
            <small>© 2016-2018 XIANSHIKEJI Ltd.</small> &nbsp;&nbsp;&nbsp;
            <small><a href="http://www.miibeian.gov.cn/">苏ICP备17002077号-1</a></small>
        </div>
    </div>
