                  ...
                  <div class="col-md-3 col-sm-6 col-xs-12">
                      <div class="info-box">
                          ...
                          <div class="info-box-content">
                              ...
                              <span class="info-box-number"><?php echo ($sum_principal); ?>&nbsp;元</span>
                          </div>
                          <!-- /.info-box-content -->
                      </div>
                      <!-- /.info-box -->
                  ...
                  <div class="col-md-3 col-sm-6 col-xs-12">
                      <div class="info-box">
                          ...
                          <div class="info-box-content">
                              ...
                              <span class="info-box-number"><?php echo ($countLoans); ?>&nbsp;笔</span>
                          </div>
                          <!-- /.info-box-content -->
                      </div>
                      <!-- /.info-box -->
                            ...
                            <form class="form-inline search-line" action="/index.php" method="get">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control selectpicker show-tick" data-live-search="true" title="按外访经理搜索" data-size="8" name="search_foreign_id" id="search_foreign_id" data-width="fit" multiple>
                                        <?php if(is_array($foreigns)): $i = 0; $__LIST__ = $foreigns;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$foreign): $mod = ($i % 2 );++$i; if($foreign["selected"] == 1): ?><option value="<?php echo ($foreign["staff_id"]); ?>" selected><?php echo ($foreign["staff_name"]); ?></option>
                                                <?php else: ?>
                                                <option value="<?php echo ($foreign["staff_id"]); ?>"><?php echo ($foreign["staff_name"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                </div>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php if(is_array($loans)): $i = 0; $__LIST__ = $loans;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$loan): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td class="text-center info"><?php echo ($loan["principal"]); ?></td>
                      <td class="text-center success"><?php echo ($loan["repayment_rmoney"]); ?></td>
                    <!--<td class="text-center "><?php echo ($loan["interest"]); ?></td>-->
                    <td class="text-center"><?php echo ($loan["cycle_name"]); ?></td>
                    <!--<td class="text-center"><?php echo ($loan["cyclical"]); ?></td>-->
                    ...
                    <td class="text-center danger" data-container="body" data-toggle="tooltip" data-placement="top" title="本金：<?php echo ($loan["cyc_benjin"]); ?>元，利息：<?php echo ($loan["cyc_interest"]); ?>元"><?php echo ($loan["cyc_principal"]); ?></td>
                    <!--<td class="text-center"><?php echo ($loan["cyc_interest"]); ?></td>-->
                    <!--<td class="text-center"><?php echo ($loan["poundage"]); ?></td>-->
                    <!--<td class="text-center"><?php echo ($loan["bond"]); ?></td>-->
                    <!--<td class="text-center"><?php echo ($loan["rebate"]); ?></td>-->
                    <td class="text-center" data-container="body" data-toggle="tooltip" data-placement="top" title="手续费：<?php echo ($loan["poundage"]); ?>元，保证金：<?php echo ($loan["bond"]); ?>元，同行返点：<?php echo ($loan["rebate"]); ?>元">
                            <?php echo ($loan["arrival"]); ?>
                        <!--<a tabindex="0" class="btn btn-xs btn-danger" role="button" data-toggle="popover"-->
                           <!--data-trigger="focus" title="Dismissible popover"-->
                           <!--data-content="And here's some amazing content. It's very engaging. Right?"><?php echo ($loan["arrival"]); ?></a></td>-->
                    <td class="text-center"><?php echo ($loan["expenditure"]); ?></td>
                      <?php if($loan["loan_status"] == 1): ?><td class="text-center" data-container="body" data-toggle="tooltip" data-placement="top" title="<?php echo ($loan["is_bond_name"]); ?>">
                    ...
                    <td class="text-center">
                        <?php if($loan["tour_id"] != 0): ?><a href="<?php echo U('home/tour/index');?>&tour_id=<?php echo ($loan["tour_id"]); ?>"><?php echo ($loan["foreign_name"]); ?></a>
                            <?php else: ?>
                            <?php echo ($loan["foreign_name"]); endif; ?>
                        </td>
                    <td class="text-center">
                    ...
                    <td class="text-center"><?php echo (date("Y-m-d",$loan["exp_time"])); ?></td>
                      <!--<td class="text-center"><a href="<?php echo U('home/repayments/index');?>&search_loan_id=<?php echo ($loan["loan_id"]); ?>"><?php echo ($loan["repay_cyclical"]); ?></a></td>-->
                    <!--<td class="text-center"><?php echo ($loan["sum_principal"]); ?></td>-->
                    ...
                    <td class="text-center">
                      ...
                      <td class="text-center"><button class="btn btn-default btn-xs" id="loan-sendmessage" attr-id="<?php echo ($loan["loan_id"]); ?>" attr-m="home" attr-c="message" attr-a="getLoanMessage" attr-style="1" attr-nowdate="1970-01-01">发送短信</button></td>
                    <td class="text-center"><span id="edit-info" attr-id="<?php echo ($loan["loan_id"]); ?>" attr-m="home" attr-c="loan" attr-a="editLoan" data-toggle="modal" data-target="#editInfoModal"><i class="fa fa-edit fa-fw"></i></span>&nbsp;<span id="delete-info" attr-id="<?php echo ($loan["loan_id"]); ?>" attr-name="<?php echo ($loan["customer_name"]); ?>的贷款记录" attr-m="home" attr-c="loan" attr-a="deleteLoan"><i class="fa fa-trash-o fa-fw"></i></span></td>
