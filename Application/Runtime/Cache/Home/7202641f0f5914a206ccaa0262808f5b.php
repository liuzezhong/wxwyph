            ...
            <div class="box-body">
              <form role="form" id="baoju-form">
                ...
                <div class="form-group col-lg-12">
                  <label>用户名</label>
                  <input type="text" class="form-control " name="username" placeholder="请输入您的姓名" value="<?php echo ($user["username"]); ?>">
                </div>
                <div class="form-group col-lg-12">
                  <label>手机号码</label>
                  <input type="text" class="form-control " name="phone" placeholder="请输入您的手机号码" value="<?php echo ($user["phone"]); ?>">
                </div>
                <div class="form-group col-lg-12">
                  <label>电子邮箱</label>
                  <input type="text" class="form-control" name="email" placeholder="请输入您的电子邮箱" value="<?php echo ($user["email"]); ?>">
                </div>
                <div class="form-group col-lg-12">
                  <label>所属部门</label>
                  <input type="text" class="form-control" name="department" placeholder="请输入您所在部门" value="<?php echo ($user["department"]); ?>">
                </div>
                <div class="form-group col-lg-12">
                  <label>职位职称</label>
                  <input type="text" class="form-control" name="position" placeholder="请输入您的职称" value="<?php echo ($user["position"]); ?>">
                </div>
                ...
                <div class="form-group col-lg-12">
                  <button type="button" class="btn btn-primary btn-block" id="add-record" attr-m="home" attr-c="other" attr-a="checkUserInfo"><i class="fa fa-check"></i>&nbsp;立即修改</button>
                </div>
