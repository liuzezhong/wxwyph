                  ...
                  <div class="panel-body panel-body-footer">
                      <form class="form-inline search-line" action="/index.php" method="get">
                          ...
                          <div class="form-group">
                              <label>支出日期&nbsp;</label>
                              <input type="text" class="form-control" placeholder="按支出时间范围搜索" size="40" name="search_datepicker" value="<?php echo ($input_datepicker); ?>" id="reservationtime">
                          </div>
          ...
          <div class="box">
            <div class="box-header">
              <!--<h3 class="box-title">Data Table With Full Features</h3>-->
                ...
                <h5><text class="text-info">支出金额合计：<?php echo ($sum_moeny); ?>（元）</text></h5>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php if(is_array($charges)): $i = 0; $__LIST__ = $charges;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$charge): $mod = ($i % 2 );++$i;?><tr>
                        <!--<td class="text-center"><?php echo ($repayment["repayments_id"]); ?></td>-->
                        <!--<td class="text-center"><?php echo ($repayment["loan_id"]); ?></a></td>-->
                        <td class="text-center"><?php echo ($charge["gmt_create"]); ?></td>
                        <td class="text-center"><?php echo ($charge["money"]); ?></td>
                        <td class="text-center"><?php echo ($charge["matter"]); ?></td>
                        <td class="text-center"><?php echo ($charge["remark"]); ?></td>
                        <?php if($userInfo["jurisdiction"] == 2): ?><td class="text-center"><?php echo ($charge["company_name"]); ?></td><?php endif; ?>
                        <td class="text-center"><span id="edit-charge" attr-id="<?php echo ($charge["charge_id"]); ?>" attr-m="home" attr-c="charge" attr-a="editCharge" data-toggle="modal" data-target="#editInfoModal"><i class="fa fa-edit fa-fw"></i></span>&nbsp;<span id="delete-info" attr-id="<?php echo ($charge["charge_id"]); ?>" attr-name="<?php echo ($charge["money"]); ?>元的记录" attr-m="home" attr-c="charge" attr-a="deleteCharge"><i class="fa fa-trash-o fa-fw"></i></span></td>
