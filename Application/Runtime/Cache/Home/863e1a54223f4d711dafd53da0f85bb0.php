          ...
          <div class="row">
              <div class="col-lg-12">
                  <div class="container">
                      <div class="row">
                          <div class="col-lg-12">
                              <?php if(is_array($loans)): $i = 0; $__LIST__ = $loans;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$loan): $mod = ($i % 2 );++$i;?><!--<div class="col-xs-6 col-md-3" style="width:160px;height: 200px;">-->
                                      <!--<a href="#" class="thumbnail">-->
                                          <!--<img src="<?php echo ($loan["image"]); ?>" class="img-responsive " style="width:150px;height:150px;">-->
                                      <!--</a>-->
                                  <!--</div>-->
                                  <div class="col-md-2 col-sm-2" >
                                      <a class="thumbnail" id="image-detail" attr-loan_id="<?php echo ($loan["loan_id"]); ?>" style="width:160px;height: 190px;cursor:pointer;">
                                          <img src="<?php echo ($loan["image"]); ?>" class="img-responsive " style="width:150px;height:150px;">
                                          <div style="position:absolute;left:25px;top:5px"><text style="color: white; font-size: 25px;"><?php echo ($loan["coutImage"]); ?></text></div>
                                          <div class="caption" >
                                              <h6 class="text-center"><?php echo ($loan["name"]); ?>&nbsp;<small><?php echo ($loan[create_time]); ?></small></h6>
