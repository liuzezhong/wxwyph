                  ...
                  <div class="col-md-3 col-sm-6 col-xs-12">
                      <div class="info-box">
                          ...
                          <div class="info-box-content">
                              ...
                              <span class="info-box-number"><?php echo ($sum_smoney); ?>&nbsp;元</span>
                          </div>
                          <!-- /.info-box-content -->
                      </div>
                      <!-- /.info-box -->
                  ...
                  <div class="col-md-3 col-sm-6 col-xs-12">
                      <div class="info-box">
                          ...
                          <div class="info-box-content">
                              ...
                              <span class="info-box-number"><?php echo ($sum_bmoney); ?>&nbsp;元</span>
                          </div>
                          <!-- /.info-box-content -->
                      </div>
                      <!-- /.info-box -->
                  ...
                  <div class="col-md-3 col-sm-6 col-xs-12">
                      <div class="info-box">
                          ...
                          <div class="info-box-content">
                              ...
                              <span class="info-box-number"><?php echo ($countRepayment); ?>&nbsp;条</span>
                          </div>
                          <!-- /.info-box-content -->
                      </div>
                      <!-- /.info-box -->
          ...
          <div class="box">
            <div class="box-header">
              <!--<h3 class="box-title">Data Table With Full Features</h3>-->
                    ...
                    <div class="panel panel-info">
                        <div class="panel-body panel-body-footer">
                            <form class="form-inline search-line" action="/index.php" method="get">
                                ...
                                <!--<label>借款号&nbsp;</label>-->
                                <!--<input type="text" class="form-control" placeholder="按借款号搜索" size="12" name="search_loan_id" value="<?php echo ($input_loan_id); ?>">-->
                                <!--</div>-->
                                <input type="hidden" class="form-control" placeholder="按借款号搜索" size="12" name="search_loan_id" value="<?php echo ($input_loan_id); ?>">

                                &nbsp;&nbsp;
                                <div class="form-group">
                                    <label>还款人姓名&nbsp;</label>
                                    <input type="text" class="form-control" placeholder="按姓名搜索" size="12" name="search_customer_name" value="<?php echo ($input_customer_name); ?>">
                                </div>
                                &nbsp;&nbsp;
                                <div class="form-group">
                                    <label>手机号码&nbsp;</label>
                                    <input type="text" class="form-control" placeholder="按手机号码搜索" size="14" name="search_customer_phone" value="<?php echo ($input_customer_phone); ?>">
                                </div>
                                &nbsp;&nbsp;
                                <div class="form-group">
                                    <label>还款时间&nbsp;</label>
                                    <input type="text" class="form-control" placeholder="按还款时间范围搜索" size="40" name="search_datepicker" value="<?php echo ($input_datepicker); ?>" id="reservationtime">
                                </div>
                ...
                <!--<h5><text class="text-info">应还金额总计：<?php echo ($sum_smoney); ?>（元）</text>&nbsp;&nbsp;&nbsp;&nbsp;<text class="text-green">实还金额总计：<?php echo ($sum_rmoney); ?>（元）</text> &nbsp;&nbsp;&nbsp;&nbsp;<text class="text-danger">违约金总计：<?php echo ($sum_bmoney); ?>（元）</text></h5>-->
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php if(is_array($repayments)): $i = 0; $__LIST__ = $repayments;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$repayment): $mod = ($i % 2 );++$i;?><tr>
                        <!--<td class="text-center"><?php echo ($repayment["repayments_id"]); ?></td>-->
                        <!--<td class="text-center"><?php echo ($repayment["loan_id"]); ?></a></td>-->
                        <td class="text-center"><?php echo (date("Y-m-d",$repayment["loan"]["create_time"])); ?></td>
                        <td class="text-center"><a href="<?php echo U('home/customer/index');?>&name=<?php echo ($repayment["customer"]["name"]); ?>"><?php echo ($repayment["customer"]["name"]); ?></a></td>
                        <td class="text-center"><?php echo ($repayment["customer"]["phone"]); ?></td>

                        <td class="text-center"><a href="<?php echo U('home/loan/index');?>&loan_id=<?php echo ($repayment["loan_id"]); ?>"><?php echo ($repayment["loan"]["principal"]); ?></a></td>
                        <td class="text-center"><?php echo ($repayment["cycles"]); ?>/<?php echo ($repayment["loan"]["cyclical"]); ?></td>
                        <td class="text-center danger"><?php echo ($repayment["s_money"]); ?></td>
                        <td class="text-center success"><?php echo ($repayment["r_money"]); ?></td>
                        <td class="text-center"><?php echo ($repayment["b_money"]); ?></td>
                        <td class="text-center"><?php echo ($repayment["gmt_repay"]); ?></td>
                        <td class="text-center"><?php echo ($repayment["staff"]["staff_name"]); ?></td>
                        <td class="text-center">
                            <?php if($repayment["pay_style"] == 1): ?>微信
                                <?php elseif($repayment["pay_style"] == 2): ?>
                                支付宝
                                <?php elseif($repayment["pay_style"] == 3): ?>
                                银行卡
                                <?php elseif($repayment["pay_style"] == 4): ?>
                                现金
                                <?php elseif($repayment["pay_style"] == 5): ?>
                                扣首期
                                <?php elseif($repayment["pay_style"] == 6): ?>
                                扣上门费<?php endif; ?>
                        </td>
                        <?php if($userInfo["jurisdiction"] == 2): ?><td class="text-center"><?php echo ($repayment["company_name"]); ?></td><?php endif; ?>
                        <td class="text-center"><?php echo ($repayment["remark"]); ?></td>
                        <td class="text-center"><span id="edit-repayments" attr-id="<?php echo ($repayment["repayments_id"]); ?>" attr-m="home" attr-c="repayments" attr-a="editRepayments" data-toggle="modal" data-target="#editInfoModal"><i class="fa fa-edit fa-fw"></i></span>&nbsp;<span id="delete-info" attr-id="<?php echo ($repayment["repayments_id"]); ?>" attr-name="<?php echo ($repayment["customer"]["name"]); ?>的还款记录" attr-m="home" attr-c="repayments" attr-a="deleteRepayments"><i class="fa fa-trash-o fa-fw"></i></span></td>
