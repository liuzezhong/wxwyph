            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    ...
                    <li <?php if(($controller_name == 'Other') AND ($action_name == 'changePwd')): ?>class="active"<?php endif; ?>><a href="<?php echo U('home/loan/changepwd');?>"><i class="fa fa-circle-o"></i> 修改密码</a></li>
                </ul>
                </li>
                <!--<li class="treeview">-->
                    <!--<a href="#">-->
        ...
        <div class="col-md-8">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">请填写借款记录信息</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" id="baoju-form">
                ...
                <div class="form-group col-lg-6">
                  <label>借贷日期</label>
                  <input type="text" class="form-control sandbox-container" name="create_time" placeholder="请选择贷款时间">
                </div>
                <!--<?php if($userInfo["jurisdiction"] == 2): ?><div class="form-group col-lg-6">
                    <label>所属公司</label>
                    <select class="form-control selectpicker show-tick" title="选择借款所属公司" data-size="8" name="company_id" >
                ...
                <div class="form-group col-lg-12">
                  <button type="button" class="btn btn-primary btn-block" id="add-record-loan" attr-m="home" attr-c="loan" attr-a="checkAdd"><i class="fa fa-check"></i>&nbsp;确认提交</button>
                </div>
