          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php if(is_array($tours)): $i = 0; $__LIST__ = $tours;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tour): $mod = ($i % 2 );++$i;?><tr>
                        <td class="text-center"><?php echo ($tour["gmt_tour"]); ?></td>
                        <td class="text-center"><?php echo ($tour["customer_name"]); ?></td>
                        <td class="text-center"><?php echo ($tour["customer_phone"]); ?></td>
                        <td class="text-center"><?php echo ($tour["location_name"]); ?></td>
                        <td class="text-center"><?php echo ($tour["staff_name"]); ?></td>
                        <td class="text-center"><?php echo ($tour["money"]); ?></td>
                        <td class="text-center"><?php echo ($tour["paystyle_name"]); ?></td>
                        <td class="text-center">
                            <?php if($tour["loan_id"] != 0): ?><a href="<?php echo U('home/loan/index');?>&loan_id=<?php echo ($tour["loan_id"]); ?>"><?php echo ($tour["is_loan"]); ?></a>
                                <?php else: ?>
                                <?php echo ($tour["is_loan"]); endif; ?>
                            </td>
                        <td class="text-center"><?php echo ($tour["remark"]); ?></td>

                        <?php if($userInfo["jurisdiction"] == 2): ?><td class="text-center"><?php echo ($tour["company_name"]); ?></td><?php endif; ?>
                        <td class="text-center"><span id="edit-tour" attr-id="<?php echo ($tour["tour_id"]); ?>" attr-m="home" attr-c="tour" attr-a="editTour" data-toggle="modal" data-target="#editInfoModal"><i class="fa fa-edit fa-fw"></i></span>&nbsp;<span id="delete-info" attr-id="<?php echo ($tour["tour_id"]); ?>" attr-name="<?php echo ($tour["customer_name"]); ?>的外访记录" attr-m="home" attr-c="tour" attr-a="deleteTour"><i class="fa fa-trash-o fa-fw"></i></span></td>
                    ...
                    <form role="form" id="baoju-form">
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <select class="form-control selectpicker show-tick" data-live-search="true" title="请选择外访区域" data-size="8" id="location_id" name="location_id" >
                                <?php if(is_array($locations)): $i = 0; $__LIST__ = $locations;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$location): $mod = ($i % 2 );++$i;?><option value="<?php echo ($location["location_id"]); ?>"><?php echo ($location["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <select class="form-control selectpicker show-tick" data-live-search="true" title="请选择支付方式" data-size="8" id="style_id" name="style_id" >
                                <?php if(is_array($paystyles)): $i = 0; $__LIST__ = $paystyles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$paystyle): $mod = ($i % 2 );++$i;?><option value="<?php echo ($paystyle["style_id"]); ?>"><?php echo ($paystyle["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
